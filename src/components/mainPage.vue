...
<br>
    <aos-vue animation="fade" data-aos-duration="600">
      ...
      <div class="column" style="margin-right: 150px; margin-left: 150px;margin-top: 0px; flex: 5%;">
        <br><br><br><br><br>
    ...
    <aos-vue animation="fade-right">
      ...
      <br>
        ...
        <img src="@/assets/projects/game_level1.png" width="650" height="400" style="border-radius: 1%;"/>
          ...
          <div class="column" style="flex: 5%;">
        <div style="margin-right: 150px; margin-left: 150px; border-radius: 1%; margin-top: 0px;">
          <br><br><br><br><br>
